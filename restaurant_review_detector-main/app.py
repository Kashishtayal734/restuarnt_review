...
def predict():
#data=pd.read_csv('C:/Users/ASUS/Desktop/NLP_DEPLOYMENT/Restaurant_Reviews.tsv', delimiter = '\t')
#corpus = []
...
#lr = LogisticRegression(random_state=0, C=0.82286, max_iter=2000)                                 #random_state- to set seed value
#lr.fit(X_train,y_train)                                                                           # Fit function adjusts weights according to data values so that better accuracy can be achieved
